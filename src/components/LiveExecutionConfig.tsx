...
import { LiveExecutionConfig, LiveAttackType, PhishingConfig, InsiderThreatConfig, RansomwareSimConfig, CloudMisconfigConfig } from '../types';
...
const attackTypes: { type: LiveAttackType; title: string; description: string; icon: React.ReactNode }[] = [
  {
    ...
    description: 'Simulated phishing attacks with trackable emails and payloads',
...
export function LiveExecutionConfigPanel({ config, onConfigChange, isEnabled, onToggle }: LiveExecutionConfigPanelProps) {
  ...
  const renderAttackSpecificConfig = () => {
    switch (config.type) {
      ...
      // Add similar configurations for other attack types...
      default:
        return null;
    }
  };
